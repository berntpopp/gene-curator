...
3. Add use_dynamic_form to Pydantic schemas in backend/app/schemas/schema_repository.py (CurationSchemaBase, CurationSchemaUpdate, CurationSchemaRead classes)
  </action>
