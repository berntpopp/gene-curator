...
must_haves:
  truths:
    - "PrecurationFormView displays precuration fields dynamically from schema via SchemaDrivenPrecurationForm delegation"
...
4. **CRITICAL after Task 2**: Load an existing precuration to confirm refactored view displays data correctly before proceeding to Task 3
5. Fill form, close tab, reopen - verify recovery dialog appears
6. Save draft - verify data persists
7. Load existing precuration - verify data displays correctly after save
</verification>
