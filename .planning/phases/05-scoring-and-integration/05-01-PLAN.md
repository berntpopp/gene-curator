...
7. Replace existing inline score display (lines 134-158) with the new sidebar approach. The current score cards within v-card-text should be REMOVED since ScoreDisplay now handles this.
