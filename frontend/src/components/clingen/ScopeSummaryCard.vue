  ...
  <v-card>
    ...
    <v-card-text>
      ...
      <div class="text-caption text-grey">
        <v-row dense>
          <v-col cols="6">
            <div><v-icon size="x-small">mdi-account-group</v-icon> {{ scopeSummary.curator_count }} curators</div>
          </v-col>
          <v-col cols="6">
            <div><v-icon size="x-small">mdi-file-document</v-icon> {{ scopeSummary.evidence_count }} evidence items</div>
          </v-col>
        </v-row>
        <div class="mt-2">
